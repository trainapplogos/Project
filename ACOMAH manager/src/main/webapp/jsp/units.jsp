...
<body>
	...
	<div id="main">
		<jsp:include page="panel.jsp">
       		<jsp:param name="headerTitle" value="Control panel: Units of measure" />
  	  	</jsp:include>
		...
		<div class="w3-container">
			<div class="flex-container">
					...
					<c:if test="${not empty units}">
						<c:forEach items="${units}" var="currentUnit">
							
								<div class="w3-card-4" style="margin: 15px;	width: 25%; min-width: 150px; border-radius: 7px;">
									<header class="w3-container w3-light-grey">
										<h4 style="white-space: nowrap; overflow: hidden;">${currentUnit.name}</h4>
									</header>
									...
									<div class="w3-container w3-center" style="align: bottom;">
										<c:out value="${empty currentUnit.description ? '<br>' : currentUnit.description}" escapeXml="false" />
										<hr>
									</div>
