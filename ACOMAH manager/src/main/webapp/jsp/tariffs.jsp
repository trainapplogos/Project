...
<body>
	...
	<div id="main">
		<jsp:include page="panel.jsp">
       		<jsp:param name="headerTitle" value="Control panel: Monthly Tariffs" />
  	  	</jsp:include>
		
		<div class="w3-container">
			<div class="flex-container">
				<!-- 	<a href="/create-tariff">Create Monthly Tariff</a> -->
				
					<c:if test="${not empty tariffs}">
						<c:forEach items="${tariffs}" var="currentTariff">
							
								<div class="w3-card-4" style="margin: 15px;	width: 25%; min-width: 150px; border-radius: 7px;">
									<header class="w3-container w3-light-grey">
										<h4 style="white-space: nowrap; overflow: hidden;">${currentTariff.name}</h4>
									</header>
									...
									<div class="w3-container w3-center" style="align: bottom;">
										<p>${currentTariff.value}</p>
										<p>${currentTariff.fromDate}</p>					
